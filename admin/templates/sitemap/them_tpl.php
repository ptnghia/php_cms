...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">';
    ...
    for($i=0;$i<count($arr_table);$i++){ $row_data=$d->o_fet("select alias,lang, cap_nhat from ".$arr_table[$i]." where
        hien_thi = 1 order by cap_nhat DESC");
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <iframe class="iframe" src="<?=URLPATH?>sitemap.xml" style="height: 534px;width: 100%;"
                    ...
                    <div class="col-sm-6">
                        <form method="post" action="">
                            <div class="form-group">
                                <textarea class=" form-control" name="content_sitemap" id="code"
                                    rows="20"><?=$sitemap?></textarea>
                            </div>
...
function completeIfInTag(cm) {
    return completeAfter(cm, function() {
        ...
        if (tok.type == "string" && (!/['"]/.test(tok.string.charAt(tok.string.length - 1)) || tok.string
