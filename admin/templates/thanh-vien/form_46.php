...
$danhmuc_sp = $d->o_fet("select * from #_category_noidung where type = 1 and id_code = 78  "._where_lang." order by id ASC");
...
<div class="card-body">
    <form method="POST" action="" class="needs-validation" novalidate>
        ...
        <?php 
            ...
            //print_r($data_sp);
        ?>
        <table class="table table-bordered table_form" id="dataTable1">
            <thead>
                <tr>
                    <th class="text-center">Code</th>
                    <th class="text-left"><?=$d->getTxt(48)?></th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?=strip_tags($value1['noi_dung'])?></td>
                    <td class="text-end">
                        $<?=  number_format($value1['link'], 2)?>
