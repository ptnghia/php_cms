...
function filenameSort($x, $y)
{
    ...
    $result = strcasecmp($x['file_lcase'], $y['file_lcase']);
...
function extensionSort($x, $y)
{
    ...
    $result = strcasecmp($x['extension'], $y['extension']);
    return $descending ? -$result : $result;
}
            ...
            <?php if($config['multiple_selection']){ ?><div class="selector">
                ...
                <div class="img-precontainer">
                    ...
                    <div class="img-container">
                        ...
                        <img <?=$file_array['extension']?> class="<?php echo $show_original ? "original" : "" ?><?php echo $is_icon_thumb ? " icon" : "" ?>" data-src="<?php echo $src_thumb;?>">
                    </div>
                </div>
